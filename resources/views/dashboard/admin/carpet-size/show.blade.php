...
<div class="content-header fade-in">
    <h1 class="fw-bold text-primary">Carpet Size Details</h1>
    <p class="text-muted">View the details of the selected carpet size.</p>
</div>
...
<div class="card shadow-lg border-0" style="background: linear-gradient(145deg, #ffffff, #f8fafc);">
    <div class="card-header bg-primary text-white py-3 rounded-top d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Carpet Size: {{ $carpetSize->name['en'] }}</h5>
        <a href="{{ route('admin.carpet-size.edit', $carpetSize) }}" class="btn btn-light btn-sm">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-4">
                    ...
                    <p>{{ $carpetSize->serviceCategory ? $carpetSize->serviceCategory->name['en'] : 'N/A' }}</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-4">
                    <h6 class="fw-semibold text-muted">Price</h6>
                    <p>{{ $carpetSize->price ? number_format($carpetSize->price, 2) : 'N/A' }}</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="mb-4">
                    ...
                    <p>{{ $carpetSize->created_at }}</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-4">
                    <h6 class="fw-semibold text-muted">Updated At</h6>
                    <p>{{ $carpetSize->updated_at }}</p>
                </div>
            </div>
        </div>
