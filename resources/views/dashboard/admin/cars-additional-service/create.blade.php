...
<div class="content-header fade-in">
    <h1 class="fw-bold text-primary">Add New Cars Additional Service</h1>
    <p class="text-muted">Create a new cars additional service with multilingual names, associated service category, and price.</p>
</div>
...
<div class="card shadow-lg border-0" style="background: linear-gradient(145deg, #ffffff, #f8fafc);">
    <div class="card-header bg-primary text-white py-3 rounded-top">
        <h5 class="card-title mb-0">Create Cars Additional Service</h5>
    </div>
    <div class="card-body p-4" style="max-height: calc(100vh - 220px); overflow-y: auto;">
        <form action="{{ route('admin.cars-additional-service.store') }}" method="POST" id="cars-additional-service-form">
            @csrf
            <div class="row">
                <div class="col-md-6">
