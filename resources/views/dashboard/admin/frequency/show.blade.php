...
<div class="content-header fade-in">
    <h1 class="fw-bold text-primary">Frequency Details</h1>
    <p class="text-muted">View the details of the selected frequency.</p>
</div>
...
<div class="card shadow-lg border-0" style="background: linear-gradient(145deg, #ffffff, #f8fafc);">
    <div class="card-header bg-primary text-white py-3 rounded-top d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Frequency: {{ $frequency->name['en'] }}</h5>
        <a href="{{ route('admin.frequency.edit', $frequency) }}" class="btn btn-light btn-sm">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-4">
                    ...
                    <p>{{ $frequency->serviceCategory ? $frequency->serviceCategory->name['en'] : 'N/A' }}</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-4">
                    <h6 class="fw-semibold text-muted">Price</h6>
                    <p>{{ $frequency->price ? number_format($frequency->price, 2) : 'N/A' }}</p>
                </div>
            </div>
        </div>
        <div class="row">
