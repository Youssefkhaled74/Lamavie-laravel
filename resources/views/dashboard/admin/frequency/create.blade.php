...
<div class="content-header fade-in">
    <h1 class="fw-bold text-primary">Add New Frequency</h1>
    <p class="text-muted">Create a new frequency with multilingual names, associated service category, and price.</p>
</div>
...
<div class="card shadow-lg border-0" style="background: linear-gradient(145deg, #ffffff, #f8fafc);">
    <div class="card-header bg-primary text-white py-3 rounded-top">
        <h5 class="card-title mb-0">Create Frequency</h5>
    </div>
    <div class="card-body p-4" style="max-height: calc(100vh - 220px); overflow-y: auto;">
        <form action="{{ route('admin.frequency.store') }}" method="POST" id="frequency-form">
            @csrf
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="d-flex gap-3 mt-4">
                <button type="submit" class="btn btn-primary btn-lg" id="submit-btn">
                    <i class="fas fa-save me-2"></i>Save Frequency
                </button>
