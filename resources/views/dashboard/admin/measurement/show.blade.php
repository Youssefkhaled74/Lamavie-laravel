...
<div class="content-header fade-in">
    <h1 class="fw-bold text-primary">Measurement Details</h1>
    <p class="text-muted">View the details of the selected measurement.</p>
</div>
...
<div class="card shadow-lg border-0" style="background: linear-gradient(145deg, #ffffff, #f8fafc);">
    <div class="card-header bg-primary text-white py-3 rounded-top d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Measurement: {{ $measurement->name['en'] }}</h5>
        <a href="{{ route('admin.measurement.edit', $measurement) }}" class="btn btn-light btn-sm">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-4">
                    ...
                    <p>{{ $measurement->name['en'] }}</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-4">
                    <h6 class="fw-semibold text-muted">Name (Arabic)</h6>
                    <p>{{ $measurement->name['ar'] }}</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="mb-4">
                    ...
                    <p>{{ $measurement->serviceCategory ? $measurement->serviceCategory->name['en'] : 'N/A' }}</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-4">
                    <h6 class="fw-semibold text-muted">Price</h6>
                    <p>{{ $measurement->price ? number_format($measurement->price, 2) : 'N/A' }}</p>
                </div>
            </div>
        </div>
        <div class="row">
