...
<div class="content-header fade-in">
    <h1 class="fw-bold text-primary">Add New Presence of Children or Pets</h1>
    <p class="text-muted">Create a new presence of children or pets with multilingual names, associated service category, and price.</p>
</div>
...
<div class="card shadow-lg border-0" style="background: linear-gradient(145deg, #ffffff, #f8fafc);">
    <div class="card-header bg-primary text-white py-3 rounded-top">
        <h5 class="card-title mb-0">Create Presence of Children or Pets</h5>
    </div>
    <div class="card-body p-4" style="max-height: calc(100vh - 220px); overflow-y: auto;">
        <form action="{{ route('admin.presence-of-children-or-pets.store') }}" method="POST" id="presence-of-children-or-pets-form">
            @csrf
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-4 position-relative">
                        ...
                        <input type="number" step="0.01" name="price" id="price" class="form-control form-control-lg rounded-3 @error('price') is-invalid @enderror" value="{{ old('price') }}" placeholder="e.g., 50.00">
                        @error('price')
                            <div class="invalid-feedback d-flex align-items-center"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="d-flex gap-3 mt-4">
                <button type="submit" class="btn btn-primary btn-lg" id="submit-btn">
                    <i class="fas fa-save me-2"></i>Save Presence of Children or Pets
                </button>
