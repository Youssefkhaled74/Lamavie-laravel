...
<div class="container-fluid">
    ...
    <div class="content-header fade-in mb-4 d-flex align-items-center justify-content-between">
        <div>
            <h1 class="fw-bold text-primary mb-1" data-en="Create Role" data-ar="إنشاء دور">Create Role</h1>
            <p class="text-muted mb-0" data-en="Create a role and assign permissions." data-ar="إنشاء دور وتعيين الصلاحيات.">Create a role and assign permissions.</p>
        </div>
    ...
    <div class="card shadow-lg border-0 rounded-4 overflow-hidden" style="background: linear-gradient(145deg, #ffffff, #f8fafc);">
        <div class="card-header py-3 px-3 text-white d-flex justify-content-between align-items-center"
            ...
            <h5 class="card-title mb-0" data-en="Role Information" data-ar="بيانات الدور">Role Information</h5>
            ...
            <form action="{{ route('admin.roles.store') }}" method="POST" id="role-form">
                                ...
                                <div class="perm-group card mb-3 border-0 shadow-sm rounded-4 overflow-hidden" data-group="{{ $gid }}">
                                    <div class="card-header bg-white d-flex justify-content-between align-items-center"
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span class="badge bg-light text-dark border group-selected-badge" data-en="0 selected" data-ar="0 محدد">0 selected</span>
                                        </div>
                ...
                <div class="d-flex gap-2 mt-4">
                    <button class="btn btn-primary btn-lg">
                        <i class="fas fa-save me-2"></i><span data-en="Create" data-ar="إنشاء">Create</span>
                    </button>
    ...
    document.querySelectorAll('.group-select').forEach(function(chk){
        chk.addEventListener('change', function(){
            ...
            document.querySelectorAll('.perm-checkbox[data-group="'+group+'"]').forEach(function(cb){
                // only select visible items when search is active
